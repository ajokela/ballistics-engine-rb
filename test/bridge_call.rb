...
failures += check(ver["engine_version"] == "0.38.0",
                  "meta.version reports engine 0.38.0 (got #{ver["engine_version"].inspect})")
failures += check(ver["result"]["engine_version"] == "0.38.0",
                  "meta.version result.engine_version is 0.38.0")
