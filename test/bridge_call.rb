...
failures += check(ver["engine_version"] == "0.37.0",
                  "meta.version reports engine 0.37.0 (got #{ver["engine_version"].inspect})")
failures += check(ver["result"]["engine_version"] == "0.37.0",
                  "meta.version result.engine_version is 0.37.0")
